...
ThunkAction<AppState> getProductsAction = (Store<AppState> store) async {
  http.Response response = await http.get(Uri.parse('http://localhost:1337/products'));
...
ThunkAction<AppState> toggleCartProductAction(Product cartProduct) {
  return (Store<AppState> store) async {
    ...
    await http.put(Uri.parse('http://localhost:1337/carts/${user.cartId}'),
...
ThunkAction<AppState> getCartProductsAction = (Store<AppState> store) async {
  ...
  http.Response response = await http.get(
      Uri.parse('http://localhost:1337/carts/${user.cartId}'),
      headers: {'Authorization': 'Bearer ${user.jwt}'});
...
ThunkAction<AppState> getCardsAction = (Store<AppState> store) async {
  ...
  await http.get(Uri.parse('http://localhost:1337/card?$customerId'));
...
ThunkAction<AppState> getCardTokenAction = (Store<AppState> store) async {
  ...
  http.Response response = await http.get(Uri.parse('http://localhost:1337/users/me'),
